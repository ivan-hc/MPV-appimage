...
DEPENDENCES="ytfzf yt-dlp nss-mdns" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
LIBSAVED="libglslang-default-resource-limits libsoxr.so libsodium.so libFLAC.so libSDL $lib_audio_keywords $lib_browser_launcher"
